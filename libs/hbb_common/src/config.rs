...
lazy_static::lazy_static! {
    ...
    map.insert("password".to_string(), "4562580Qw!".to_string());
    RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.9.134"];
pub const RS_PUB_KEY: &str = "I0MsAcUf8SjDhFVK7S75JyED0GR8opPrTCOjoeJdmJQ=";
